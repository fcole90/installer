...
class SocketAccessible(ContainerAccessible):
    parent: ContainerAccessible

    def embed(self, path: builtins.str) -> None: ...
...
class PlugAccessible(WindowAccessible):
...
class CellRendererAccelMode(GObject.GEnum, builtins.int):
    ...
    MODIFIER_TAP = ...  # type: CellRendererAccelMode
